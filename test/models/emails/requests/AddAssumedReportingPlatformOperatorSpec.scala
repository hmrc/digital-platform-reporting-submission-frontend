...
import models.email.requests.{AddAssumedReportingPlatformOperator, AddAssumedReportingUser}

class AddAssumedReportingPlatformOperatorSpec extends SpecBase {

  ".apply(...)" - {
    "must create AddAssumedReportingPlatformOperator object" in {
      AddAssumedReportingPlatformOperator.apply("test@test.com", "poName", "9:15am (GMT) on 17th November 2024", "assuming platform operator", "business name", "2024") mustBe
        AddAssumedReportingPlatformOperator(
