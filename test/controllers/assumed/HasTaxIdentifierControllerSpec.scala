...
import views.html.assumed.HasTaxIdentifierView
...
class HasTaxIdentifierControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HasTaxIdentifier Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(HasTaxIdentifierPage, true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val result = route(application, request).value
        val answers = emptyUserAnswers.set(HasTaxIdentifierPage, true).success.value
