...
import views.html.assumed.update.RegisteredInUkView
...
class RegisteredInUkControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val formProvider = new RegisteredInUkFormProvider()
  ...
  lazy val registeredInUkRoute = routes.RegisteredInUkController.onPageLoad(operatorId, caseId).url
  ...
  "RegisteredInUk Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual RegisteredInUkPage.nextPage(caseId, answers).url
      }
    }
