  ...
  "Check Platform Operator Controller" - {
    ...
    "onSubmit(...)" - {
      ...
      "must redirect to Check Platform Operator when 'true' is selected and business details have not been confirmed" in {
        ...
        when(mockRecentSubmissionsService.confirmBusinessDetailsFor(any())(any()))
        ...
        verify(mockRecentSubmissionsService, times(1)).confirmBusinessDetailsFor(eqTo(operatorId))(any())
