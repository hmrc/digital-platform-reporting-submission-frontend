...
import pages.HasTaxIdentifierPage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.HasTaxIdentifierView
...
class HasTaxIdentifierControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HasTaxIdentifier Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(HasTaxIdentifierPage, true).success.value
