...
class InternationalTaxIdentifierPageSpec extends AnyFreeSpec with Matchers {
  ...
  ".nextPage" - {
    ...
    "must go to Check Answers" in {
      ...
      InternationalTaxIdentifierPage.nextPage(reportingPeriod, emptyAnswers).mustEqual(routes.CheckYourAnswersController.onPageLoad(operatorId, reportingPeriod))
    }
  }
}
