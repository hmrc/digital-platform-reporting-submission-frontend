...
document.querySelectorAll(".custom-select select").forEach(function (select) {
    ...
    button.insertAdjacentHTML("beforeend", `
        <svg xmlns="http://www.w3.org/2000/svg" class="autocomplete__dropdown-arrow-down" focusable="false">
             <g stroke="none" fill="none" fill-rule="evenodd"><polygon fill="#000000" points="0 0 22 0 11 17"></polygon></g>
        </svg>     
    `);
