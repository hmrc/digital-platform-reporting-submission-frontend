...
package models.pageviews.assumed.update
...
case class SubmissionConfirmationViewModel(summaryList: SummaryList,
                                           userEmail: String,
                                           poEmail: String,
...
object SubmissionConfirmationViewModel {

  def apply(summaryList: SummaryList,
            subscriptionInfo: SubscriptionInfo,
            platformOperator: PlatformOperator,
            emailsSentResult: EmailsSentResult): SubmissionConfirmationViewModel = SubmissionConfirmationViewModel(
