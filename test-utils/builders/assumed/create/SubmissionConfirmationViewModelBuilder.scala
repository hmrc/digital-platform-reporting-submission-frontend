...
package builders.assumed.create
...
object SubmissionConfirmationViewModelBuilder {

  val aSubmissionConfirmationViewModel: SubmissionConfirmationViewModel = SubmissionConfirmationViewModel(
